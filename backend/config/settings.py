...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-nr^&vz0xv*je%4x!1vvdvi7y%pn)0)(d)=u0&2wuo=))o8(cod')
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'support@markstrades.com').strip()

# Use custom database-backed SMTP backend
EMAIL_BACKEND = 'core.email_backend.DatabaseSMTPBackend'

FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://markstrades.com').strip()
