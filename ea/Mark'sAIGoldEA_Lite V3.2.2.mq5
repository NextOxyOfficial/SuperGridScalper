...
#define BuyTrailingStartPips    3.0   // কত pip profit হলে trailing শুরু হবে (Trailing activation threshold - lower for earlier lock)
#define BuyInitialSLPips        2.0   // প্রথমে SL কত pip profit এ set হবে (Initial SL when trailing starts - breakeven lock)
#define BuyTrailingRatio        0.65  // প্রতি 1 pip trail এ SL কত pip move করবে (0.65 = 65% of price movement - let profit breathe)
...
#define SellTrailingRatio       0.65  // SELL এর জন্য trailing ratio - higher = more profit breathing
